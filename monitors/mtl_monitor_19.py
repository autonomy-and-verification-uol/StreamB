...
class mtl_monitor_19(BaseMonitor):
...
def main(argv):
	global pub, monitor
	rospy.init_node('mtl_monitor_19', anonymous=True)
	monitor = mtl_monitor_19()
	...
	pub = rospy.Publisher(name = 'mtl_monitor_19', data_class = TimedBool, latch = True, queue_size = 1000)
	rospy.spin()

...
class mtl_monitor_25(BaseMonitor):
...
def main(argv):
	global pub, monitor
	rospy.init_node('mtl_monitor_25', anonymous=True)
	monitor = mtl_monitor_25()
	...
	pub = rospy.Publisher(name = 'mtl_monitor_25', data_class = TimedBool, latch = True, queue_size = 1000)
	rospy.spin()

...
class mtl_monitor_26(BaseMonitor):
...
def main(argv):
	global pub, monitor
	rospy.init_node('mtl_monitor_26', anonymous=True)
	monitor = mtl_monitor_26()
	...
	pub = rospy.Publisher(name = 'mtl_monitor_26', data_class = TimedBool, latch = True, queue_size = 1000)
	rospy.spin()

...
def main(argv):
	...
	rospy.init_node('greater_eq_transducer_7', anonymous=True)
	pub = rospy.Publisher(name = 'greater_eq_transducer_7', data_class = TimedBool, latch = True, queue_size = 1000)
